"""
Gestión de slots de la dmsMessageTable — módulo compartido entre drivers.

Cualquier driver que implemente VMSDriver puede usar SlotManager directamente.
No contiene nada específico de ningún fabricante.
"""
...
class SlotManager:
    """
    Gestor de slots de la dmsMessageTable.
